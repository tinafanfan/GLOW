...
parser.add_argument("--iter", default=60000, type=int, help="maximum iterations")
# parser.add_argument("--num_epoch", default=10, type=int, help="number of epoch")
...
#     optimizer.load_state_dict(torch.load('optim_015001.pt'))
#     model.load_state_dict(torch.load('model_015001.pt'))
#     print('加載成功！')

    my_dataloader = CelebALoader('/home/ubuntu/DL-lab/lab7/task_2/cglow')
    trainloader = DataLoader(my_dataloader, batch_size=args.batch, shuffle=True)
